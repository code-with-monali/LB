...
unsigned int Addition(unsigned int iValue1, unsigned int iValue2)
{
  ...
  iResult = iValue1 + iValue2;   //iresult ha 1 local variable aahe.ethe dukandar saman deto.
  return iResult;
}
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////
...
int main()
{
    ...
    iAns = Addition(iNo1, iNo2);     // ethun function call krtoy. iAns hi rikami pishvi aahe.
