...
void SinglyLL::DeleteFirst()
{
    ...
    else if(First->next == NULL)  //Singly node in LL
    {
...
int main()
{
   ...
   while(1)
   {
    ...
    cout<<"4: Insert node from first position\n ";
    cout<<"5: Insert node from last position\n ";
    cout<<"6: Insert node from the given  position\n ";
    ...
    switch(iChoice)
    {
        case 1:
           ...
           case 3:
           cout<<"Enter the value that you want to inset : \n";
           cin>>iValue;
